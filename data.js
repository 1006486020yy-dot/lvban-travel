...
(function(){
  ...
  load('new-trip-form-v2.js?v=20260826-days-4');load('date-range-final.js?v=20260826-3');load('date-range-layout-final.js?v=20260825-final-1');load('city-ui-final.js?v=20260826-final-3');load('brand-header-logo.js?v=20260902-1');load('data/ai-ui-final-fix.js?v=20260915-4');load('data/ai-composer-hard-fix.js?v=20260915-6');load('data/ai-chat-history.js?v=20260916-1');load('data/ai-ui-mockup-match-v2.js?v=20260916-1');load('data/ai-quick-prompts-v1.js?v=20260918-2');load('data/ai-home-ui-final-v3.js?v=20260916-1');load('data/ai-ui-layout-correction-v4.js?v=20260916-1');load('data/ai-hero-cleanup-v1.js?v=20260916-1');load('data/ai-hero-cleanup-v2.js?v=20260916-1');load('data/ai-ui-layout-correction-v5.js?v=20260918-2');load('data/ai-itinerary-intent-v2.js?v=20260916-1');load('data/ai-itinerary-intent-v3.js?v=20260916-2');
