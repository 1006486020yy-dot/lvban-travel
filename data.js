...
(function(){
  ...
  const mapSpot=x=>({id:x.spotId||x.id,spotId:x.spotId||x.id,name:x['景点名称']||x.name||'',city:x['城市']||x.city||'',province:x['省份']||x.province||'',type:x['类型']||x.type||'',address:x['地址']||x.address||'',highlight:x['简介']||x.highlight||'',note:x['简介']||x.note||'',recommendedTime:x['推荐游玩时间']||'',recommendTime:x['推荐游玩时间']||'',season:x['推荐季节']||'',ticket:x['门票']||x.ticket||'',price:x['门票']||x.price||'',openTime:x['开放时间']||x.openTime||'',transport:x['交通']||x.transport||'',latlng:x['经纬度']||x.latlng||'',image:x['图片']||x.image||'',tags:x['标签']||x.tags||'',hot:x['热门程度']||x.hot||''});
  ...
  load('new-trip-form-v2.js?v=20260826-days-4');load('date-range-final.js?v=20260826-3');load('date-range-layout-final.js?v=20260825-final-1');load('city-ui-final.js?v=20260826-final-3');load('brand-header-logo.js?v=20260902-1');load('data/ai-ui-final-fix.js?v=20260915-4');load('data/ai-composer-hard-fix.js?v=20260915-6');load('data/ai-chat-history.js?v=20260916-1');load('data/ai-ui-mockup-match-v2.js?v=20260916-1');load('data/ai-quick-prompts-v1.js?v=20260916-3');load('data/ai-home-ui-final-v3.js?v=20260916-1');load('data/ai-ui-layout-correction-v4.js?v=20260916-1');load('data/ai-hero-cleanup-v1.js?v=20260916-1');load('data/ai-hero-cleanup-v2.js?v=20260916-1');load('data/ai-ui-layout-correction-v5.js?v=20260916-1');load('data/ai-itinerary-intent-v2.js?v=20260916-1');
