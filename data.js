...
(function(){
  ...
  load('new-trip-form-v2.js?v=20260826-days-4');load('date-range-final.js?v=20260826-3');load('date-range-layout-final.js?v=20260825-final-1');load('city-ui-final.js?v=20260826-final-3');load('brand-header-logo.js?v=20260902-1');load('data/ai-ui-final-fix.js?v=20260915-1');load('data/ai-gpt-ui.js?v=20260915-1');
