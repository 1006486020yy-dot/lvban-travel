...
(function(){
  ...
  function bindGo(){if(window.__lvbanAiQuickGoWrappedV11)return;const original=window.go;if(typeof original!=='function')return;window.go=function(id){const r=original.apply(this,arguments);setTimeout(()=>{if(id==='ai')sync();else{const el=document.getElementById(ROOT_ID);if(el)el.classList.add('lv-ai-quick-hidden')}},0);return r};window.__lvbanAiQuickGoWrappedV11=true}
